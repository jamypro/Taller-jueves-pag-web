...
function inicializarAnimaciones() {
  ...
  const observadorAnimaciones = new IntersectionObserver(function (
    entradas,
    observador,
  ) {
  ...
  console.log(
    `👁️ IntersectionObserver: vigilando ${elementosAAnimar.length} elementos para animar.`,
  );
}
    ...
    link.addEventListener("click", function (evento) {
      ...
      if (elementoDestino) {
        ...
        const posicionElemento =
          elementoDestino.getBoundingClientRect().top + window.scrollY - 80;
